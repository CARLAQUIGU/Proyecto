											...
											<div class="modal-dialog modal-dialog-centered">
												<div class="modal-content">
													<div class="modal-header">
														<h5 class="modal-title">Registro de Provincia</h5>
														<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
													</div>
													<div class="modal-body">
													<form action="index.php?controller=provincia&action=GuardarProvincia" method="post">
														<br>
														<input type="hidden" id="id" name="id">
														<label for="">Provincia</label>
														<input onblur="mayus(this);" type="text" class="form-control" name="nombre" id="nombre" aria-describedby="helpId" placeholder="Nombre Provincia">
														<br>
                                ...
                                <table class="table table-striped table-bordered" id="example" name="example">
                                    ...
                                    <tbody>
                                        ...
                                        $a=1;
                                                    ...
                                                    foreach ($provincia->mostrar() as $pro) {?>
                                        <tr>
                                            <td><?php echo $a++; ?></td>
                                            <td><?php echo $pro->nombre; ?></td>
											<td class='hide'><?php echo $pro->id?></td>
                                            <td>
												<button type="button" onclick="capturar()"  class="btn btn-light px-5 radius-30"><i class='bx bx-pencil mr-1'></i>Editar</button>	 
												<a class="btn btn-light px-5 radius-30" onclick="javascript:return confirm('ESTAS SEGURO DE ELIMINAR ESTE REGISTRO?');" href="index.php?controller=provincia&action=Estado&id=<?php echo $pro->id;?>"><i class='bx bx-trash mr-1'></i>Eliminar</a></td>
